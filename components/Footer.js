...
function Footer() {
    return (
        <footer className="grid w-full divide-y-[1px] divide-gray-300 bg-gray-100 text-sm text-gray-500">
            <div className="px-8 py-3"><p>South Africa</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 grid-flow-row-dense ">
                ...
                <div className="flex justify-center space-x-8 md:justify-self-start whitespace-nowrap"> 
                    <p>Advertising</p>
                    <p>Business</p>
...
// Grid and columns
// Start off in a mobile view and then when we hit the larger screans